  ...
  <div class="container">
    ...
    <div class="wrapper animated fadeInLeft">
      <div class="company-info">
		...
		<h5>Always worth checking this page just to make sure you&#39;re not trying to send a duplicate booking in. (This system will not allow you to!)</h5>
        <ul>
...
$sql = sprintf('SELECT Site, Scheduled, FromTime, ToTime, Reconciled, NOTAM, NOTAMlink FROM CANP WHERE Scheduled >= DATE_ADD(CURDATE(), INTERVAL 0 DAY) ORDER BY Scheduled, Site');
...
echo('	<br><br><small>This is a list of what has been sent through this utility/website. It does <b>not</b> include what may have been phoned or emailed through to Low Flying Coord. You&#39;d need to check <a href="https://notaminfo.com/ukmap/" target="_blank"> NOTAM Info</a> for that.</small>
      </div>
    </div>
  </div>
</body>
