function populateclub(s0, s1) {
  ...
  s1.innerHTML = "";
  if (s0.value == "Hill") {
    var optionArray0 = ["|", "Avon|Avon", "Cayley|Cayley", "Condors|Condors", "Cumbria|Cumbria", "Dales|Dales", "Derbyshire|Derbyshire", "Dover and Folkestone|Dover and Folkestone", "East Anglia Coastal|East Anglia Coastal", "Flying Fever|Flying Fever", "Flying Frenzy|Flying Frenzy", "Highland|Highland", "Lanarkshire and Lothian|Lanarkshire and Lothian", "Long Mynd|Long Mynd", "Malvern|Malvern", "Mid Wales|Mid Wales", "North Devon|North Devon", "North Wales|North Wales", "North Yorks|North Yorks", "Northumbria|Northumbria", "Peak|Peak", "Pennine|Pennine", "SE Wales|SE Wales", "Sky Surfing|Sky Surfing", "Snowdonia|Snowdonia", "South Devon|South Devon", "Southern|Southern", "SW Wales|SW Wales", "Thames Valley|Thames Valley", "Welsh Borders|Welsh Borders", "Wessex|Wessex", "Wingbeat|Wingbeat"];
  } else if (s0.value == "Power") {
    var optionArray0 = ["|", "Fat Paramotor|Fat Paramotor", "Green Dragons|Green Dragons", "North Devon|North Devon", "Rutland|Rutland", "Ufly4fun|Ufly4fun"];
  } else if (s0.value == "Aerotow") {
    var optionArray0 = ["|", "Cambridgeshire|Cambridgeshire", "Green Dragons|Green Dragons", "Malvern Aerotow|Malvern Aerotow", "Midland|Midland"];
  } else if (s0.value == "Tow/Winch") {
    var optionArray0 = ["|", "Cloudbase|Cloudbase", "Green Dragons|Green Dragons", "Rutland|Rutland", "Suffolk|Suffolk", "XClent|XClent"];
  }
...
function populateloc(s1, s2) {
  ...
  var optionArray1 = ["South Cerney SU055987|South Cerney"];
  ...
  } else if (s1.value == "Green Dragons") {
    var optionArray1 = ["Woldingham TQ376564|Woldingham"];
    ...
    var optionArray1 = ["|", "Black Knoll SO393887|Black Knoll", "Camlo SO028705|Camlo", "Clatter SO004964|Clatter", "Clunbury SO375801|Clunbury", "Corndon SO310967|Corndon", "Lanfawr SO295967|Lanfawr", "Lawley SO493974|Lawley",
      "Llandinam SO045884|Llandinam", "Long Mynd SO404919|Long Mynd", "Sarn SO227901|Sarn", "Shepherds Tump SO154653|Shepherds Tump", "Wrekin SJ631085|Wrekin"];
  ...
  var optionArray1 = ["Croft Farm SO908430|Croft Farm"];
    ...
    var optionArray1 = ["|", "Codden Hill SS584296|Codden Hill", "Cornborough SS417288|Cornborough", "Cranford SS353213|Cranford", "Putsborough SS440407|Putsborough", "Trentishoe SS628479|Trentishoe", "Woolacombe SS458426|Woolacombe"];
...
// Here's the suggested day for CANP. It is cut off or weekend days when LFBC closes on Friday afternoon.
  ...
  // this needs to appear on Monday if today is a weekend day or after LFBC closure on Friday.
